...
$stmt = $db->prepare("UPDATE Competitions set participants = (select count(Association.user_id) from Association where Association.id = :id) where Competitions.id = :id");
