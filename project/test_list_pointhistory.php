...
if (isset($_POST["search"]) && !empty($query)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT PointsHistory.id, points_change, Users.username from PointsHistory JOIN Users on PointsHistory.user_id = Users.id WHERE username like :q LIMIT 10");
...
?>
<form method="POST">
    <input name="query" placeholder="points_change" value="<?php safer_echo($query); ?>"/>
