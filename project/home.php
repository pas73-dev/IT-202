...
$Wresults = [];
    $db = getDB();
    $stmt = $db->prepare("SELECT score FROM Users JOIN Scores on Users.id = Scores.user_id where DATEPART(week, Scores.created) = 47 order by Scores.created desc LIMIT 10");
