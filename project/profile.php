...
if (isset($_POST["query"])) {
    $query = $_POST["query"];
    $db = getDB();
    $stmt = $db->prepare("SELECT Scores.created, Scores.score as sScore FROM Users JOIN Scores on Users.id = Scores.user_id where Users.id = 3 order by Scores.created desc LIMIT 10");
